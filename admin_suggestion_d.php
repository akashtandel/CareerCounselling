    ...
    <section class="content">
		...
		<div class="card">
            <div class="card-header">
			  ...
			  <br>
              <h3 class="card-title">
					<a href="admin_suggestion.php"><u>Science <font color="red"><?php echo $ss;?></font> Suggestions</u></a>,
					<a href="admin_suggestion_c.php"><u>Commerce <font color="red"><?php echo $cs;?></font> Suggestions</u></a>,
					<a href="admin_suggestion_a.php"><u>Arts <font color="red"><?php echo $as;?></font> Suggestions</u></a>,
					<a href="admin_suggestion_v.php"><u>Vocational <font color="red"><?php echo $vs;?></font> Suggestions</u></a>.
				</h3>
            </div>
		</div>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><font color="red"></font>Suggestions Details</h3>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$sql1=mysqli_query($con,"select r_id,StudentName,date,sl1,cl1,al1,vl1,sl2,cl2,al2,vl2,stream,r.status from tbl_result r,tbl_studentmaster sm where sm.StudentId=r.StudentId");
