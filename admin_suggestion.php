  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		...
		<div class="card">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><font color="red">Science </font>Suggestions Details</h3>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$sql1=mysqli_query($con,"select r_id,StudentName,date,sl1,cl1,al1,vl1,sl2,cl2,al2,vl2,r.status from tbl_result r,tbl_studentmaster sm where sm.StudentId=r.StudentId && stream='Science'");
