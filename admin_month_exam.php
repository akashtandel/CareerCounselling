  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-6">
			...
			<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Months wise Exam Search</h3>
              </div>
	...
	if(isset($_POST['month']))
	 {
		...
		$res = mysqli_query($con,"select * from tbl_result where date_format(date,'%m')='$m'");
    ...
    <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Month wise Exams</h3>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$sql1=mysqli_query($con,"select r_id,StudentName,sl1,cl1,al1,vl1,sl2,cl2,al2,vl2,stream,r.status from tbl_result r,tbl_studentmaster sm where sm.StudentId=r.StudentId && date_format(r.date,'%m')='$m'");
