    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['test', 'marks'],
          <?php
		  $sqls="select * from tbl_marks";
		  $cmds=mysqli_query($con,$sqls);
		  while($ress=mysqli_fetch_assoc($cmds))
		  {
			  echo"['".$ress['test']."',".$ress['marks']."],";
		  }
		  ?>
        ]);

        var options = {
          title: 'Your Result from Marks'
        };
					...
					<div class="signup-form"><!--sign up form-->
						<form name="form1" action="" method="post">
							...
							<!--<div class="form-group col-md-20">
				                <input type="text" name="regemail" class="form-control" required="required" placeholder="What happened ?"/>
							</div>-->
							<div class="form-group col-md-20">				
